...
import { usuarioLoginDTO, usuarioPublicoDTO } from "../usuarios/dto/usuario.response.js";
...
const guardarUsuario = async (req, res) => {
  try {
    ...
    return res.status(statusCode).json(ApiResponse.getResponse(statusCode, message, null));
  }
};
